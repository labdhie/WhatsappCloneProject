...
public class Client implements ActionListener
{
    ...
    static JPanel a1;       //defined globally to access in action listener bcoz it is only in the scope of contructor server
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            right.setBackground(new Color(51,51,51));
            ...
            vertical.setBackground(new Color(51,51,51));
            ...
            while(true)
                {
                    ...
                    left.setBackground(new Color(51,51,51));
